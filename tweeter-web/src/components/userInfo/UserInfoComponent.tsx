...
const UserInfo = () => {
  ...
  if (!presenter.current) {
    presenter.current = new UserInfoPresenter(listener);
  }
  ...
  const followDisplayedUser = async (
    ...
    event.preventDefault();
    await presenter.current!.followDisplayedUser(authToken!, displayedUser!);
  };
  ...
  const unfollowDisplayedUser = async (
    ...
    event.preventDefault();
    await presenter.current!.unfollowDisplayedUser(authToken!, displayedUser!);
  };
